    ...
    try:
        ...
        if len(df_filelist)>0:
            ...
            for i in range(len(filelist)):
                ...
                # ex:  HS_H08_20210612_0030_B01_JP02_R10_S0101
                # himawari standard(HS)_satellitename(H08)_YYYYMMDD_observation starttime(hhmm)_bandnumber(B01)_Japanareaand number(JP02)_Region/landmarkarea(R10)_spatialresoultion(S0101)
